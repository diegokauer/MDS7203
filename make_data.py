...
kmzfile = f'./data/kmz/{station_id}.kmz'
shpfile = f'./data/shp/{station_id}/{station_id}.shp'
bands = f'./data/results/{station_id}/bands'
crops_bands = f'./data/results/{station_id}/bands/crops'
dataframe_path = f'./data/results/{station_id}/dataframes'
arrays_path = f'./data/results/{station_id}/arrays'
